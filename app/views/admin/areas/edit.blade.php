...
@stop<div class="row">
	...
	<div class="number-field">
		...
		{{ Form::text('number',$area->number, array('required' => 'required', 'placeholder'=> Lang::get('areas.number'))) }}
	<small class="error">{{Lang::get('form.error--empty')}}</small>
	</div>
	<div class="description-field">
		{{ Form::label('description', Lang::get('areas.description').':') }}
		{{ Form::text('description',$area->description, array('required' => 'required', 'placeholder'=> Lang::get('areas.description'))) }}
	<small class="error">{{Lang::get('form.error--empty')}}</small>
	</div>
	...
	<div class="cell_phone-field">
		...
		{{ Form::text('cell_phone',$area->cell_phone, array('required' => 'required', 'placeholder'=> Lang::get('areas.cell_phone'))) }}
	<small class="error">{{Lang::get('form.error--empty')}}</small>
	</div>
	<div class="office_phone-number-field">
		{{ Form::label('office_phone', Lang::get('areas.office_phone').':') }}
		{{ Form::text('office_phone',$area->office_phone, array('required' => 'required', 'placeholder'=> Lang::get('areas.office_phone'))) }}
	<small class="error">{{Lang::get('form.error--empty')}}</small>
	</div>
	<div class="email-field">
		{{ Form::label('email', Lang::get('areas.email').':') }}
		{{ Form::text('email',$area->email, array('required' => 'required', 'placeholder'=> Lang::get('areas.email'))) }}
	<small class="error">{{Lang::get('form.error--empty')}}</small>
	</div>
	<div class="ubication-field">
		{{ Form::label('ubication', Lang::get('areas.ubication').':') }}
		{{ Form::text('ubication',$area->ubication, array('required' => 'required', 'placeholder'=> Lang::get('areas.ubication'))) }}
	<small class="error">{{Lang::get('form.error--empty')}}</small>
	</div>
