...
@stop<div class="row">
	...
	<div class="email-field">
		{{ Form::text('email', null, array('class'=>'', 'placeholder'=>Lang::get('form.email_or_username'), 'required' =>'required' ,'maxlength' => Config::get('maxlengthuser.email') )) }}
	...
	<br />
		...
		{{-- HTML::link('user/register', Lang::get('form.account--new'))--}}
